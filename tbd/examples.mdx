...
**ethosian is a framework for building agentic systems**, engineers use ethosian to:

- **Build Agents with memory, knowledge, tools and reasoning.**
- **Build teams of Agents that can work together.**
- **Chat with Agents using a beautiful UI.**
...
<Steps>
  ...
  <Step title="Export your OpenAI key">
    ...
    ethosian works with every LLM but for these examples let's use OpenAI.
