...
An example `WorkspaceSettings` used by the `llm-app` template. View this file on [github](https://github.com/ethosianhq/llm-app/blob/main/workspace/settings.py)

```python workspace/settings.py
from pathlib import Path

from ethosian.workspace.settings import WorkspaceSettings
