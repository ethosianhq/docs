...
```bash terminal
ethosian ws up --env prd --infra aws --name listener
```

```bash shorthand
ethosian ws up -e prd -i aws -n listener
```
...
```bash terminal
ethosian ws patch --env prd --infra aws --name listener
```

```bash shorthand
ethosian ws patch -e prd -i aws -n listener
```
