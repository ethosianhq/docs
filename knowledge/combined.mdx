...
We are using a local PgVector database for this example. [Make sure it's running](https://docs.ethosian.com/vectordb/pgvector)
...
website_knowledge_base = WebsiteKnowledgeBase(
    urls=["https://docs.ethosian.com/introduction"],
