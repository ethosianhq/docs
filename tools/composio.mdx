...
[**ComposioTools**](https://docs.composio.dev/framework/ethosian) enable an Agent to work with tools like Gmail, Salesforce, Github, etc.

## Prerequisites

The following example requires the `composio-ethosian` library.

```shell
pip install composio-ethosian
...
from composio_ethosian import Action, ComposioToolSet
