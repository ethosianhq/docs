...
The following agent will use Apify to crawl the webpage: https://docs.ethosian.com/introduction and summarize it.
...
agent.print_response("Tell me about https://docs.ethosian.com/introduction", markdown=True)
```
...
- View on [Github](https://github.com/ethosianhq/ethosian/blob/main/ethosian/tools/apify.py)
