...
agent.print_response("Search web page: 'https://docs.ethosian.com/introduction'", markdown=True)
```
...
- View on [Github](https://github.com/ethosianhq/ethosian/blob/main/ethosian/tools/website.py)
