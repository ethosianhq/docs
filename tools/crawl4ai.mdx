...
The following agent will scrape the content from the https://github.com/ethosianhq/ethosian webpage:
...
- View on [Github](https://github.com/ethosianhq/ethosian/blob/main/ethosian/tools/crawl4ai_tools.py)
