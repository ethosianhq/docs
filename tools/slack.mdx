...
agent.print_response("Send a message 'Hello from ethosian!' to the channel #general", markdown=True)
...
- View on [Github](https://github.com/ethosianhq/ethosian/blob/main/ethosian/tools/slack.py)
