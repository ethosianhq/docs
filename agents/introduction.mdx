...
Engineers use ethosian to build agents with memory, knowledge, tools and reasoning.
...
<Steps>
  ...
  <Step title="Run the agent">
    ...
    ```shell
    pip install ethosian openai duckduckgo-search newspaper4k lxml_html_clean
    ```
