...
ethosian not only makes building Agents easy but also provides pre-built templates for agentic systems that you can deploy to your own AWS account. Here's how they work:

- Create your codebase using a template: `ethosian ws create`
- Run your application locally: `ethosian ws up`
- Run your application on AWS: `ethosian ws up prd:aws`
