---
title: "Portkey"
description: "Enhance your ethosian agents with Portkey for reliability, efficiency, and advanced features"
---

# Portkey Integration with ethosian

<img
  src="https://raw.githubusercontent.com/siddharthsambharia-portkey/Portkey-Product-Images/main/Portkey-ethosian.png"
  alt="Portkey Metrics Visualization"
  width="70%"
/>

[Portkey](https://portkey.ai) is a 2-line upgrade to make your ethosian agents reliable, cost-efficient, and fast.

Portkey adds 4 core production capabilities to any ethosian agent:
...
```bash
pip install ethosian portkey-ai
```

2. **Configure ethosian with Portkey:**
...
And, that's it! With just this, you can start logging all of your ethosian requests and make them reliable.
...
Portkey offers a range of advanced features to enhance your ethosian agents. Here's an overview:
...
For a hands-on example of integrating Portkey with ethosian, check out our notebook:

[![Google Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://git.new/ethosian-docs)
